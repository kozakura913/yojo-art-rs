...
#[derive(
	PartialEq, Eq, Clone, Default, Debug, Serialize, Deserialize, FromSqlRow, AsExpression,
)]
...
impl ToSql<Jsonb, diesel::pg::Pg> for FileProperties
where
...
impl<DB: diesel::backend::Backend> FromSql<Jsonb, DB> for FileProperties
where
