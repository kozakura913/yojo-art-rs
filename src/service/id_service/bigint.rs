...
pub fn parse_big_int36(s: &str) -> Result<num::BigInt, &'static str> {
	...
	parse_big_int_chunked(&s.to_ascii_uppercase(), "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ", 10, num::BigInt::from_i32(36).unwrap().pow(10))
}
...
pub fn parse_big_int16(s: &str) -> Result<num::BigInt, &'static str> {
	...
	parse_big_int_chunked(&s.to_ascii_uppercase(), "0123456789ABCDEF", 13, num::BigInt::from_i32(16).unwrap().pow(13))
}

pub fn parse_big_int32(s: &str) -> Result<num::BigInt, &'static str> {
	// log_32(Number.MAX_SAFE_INTEGER) => 10.6
	// so we process 10 chars at once
	parse_big_int_chunked(s, "0123456789ABCDEFGHJKMNPQRSTVWXYZ", 10, num::BigInt::from_i32(32).unwrap().pow(10))
}
